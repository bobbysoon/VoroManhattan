#version 120
#define N 15
vec2 P[N] = vec2[](vec2(423.665557,422.689239), vec2(366.743838,422.692021), vec2(358.255467,431.179070), vec2(326.513298,431.183473), vec2(324.610680,429.279725), vec2(319.728453,429.276624), vec2(319.746348,405.775874), vec2(331.903327,393.610984), vec2(331.905390,364.851618), vec2(338.317276,358.443766), vec2(351.544244,358.430717), vec2(358.255467,351.722553), vec2(397.152821,351.693771), vec2(397.157883,379.285086), vec2(423.658611,405.775874));
bool O[N] = bool[](false,false,false,false,false,true,true,true,true,true,true,true,false,false,false);
